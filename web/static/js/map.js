...
var species =  d3.json(`http://127.0.0.1:5000/api/v1.0/species/${taxonid}`, function(data) {
// console.log(data);
...
// species_coordinates_dict.country_name = country.country_name
// species_coordinates_dict.country_code = country.country_code
